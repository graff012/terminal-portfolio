        ...
        <Card className="bg-card border-primary/30 shadow-lg shadow-primary/10 crt-effect">
          <div className="p-8">
            <div className="terminal-text text-center">
              <pre className="text-xs text-primary/80 mb-6 overflow-x-auto glitch">{asciiArt}</pre>
              ...
              <div className="flex justify-center gap-6 mb-8">
                <Link
                  ...
                  target="_blank"
                  className="terminal-hover flex items-center gap-2 text-primary/80 hover:text-primary transition-colors"
                >
              ...
              <div className="space-y-3 text-left max-w-md mx-auto">
                <div className="text-primary/80">Available commands:</div>
              ...
              <div className="mt-6 text-primary/60 text-sm">
                <TypingText text="Use the navigation above or click any command to explore" speed={40} />
              </div>
            </div>
          </div>
        </Card>
