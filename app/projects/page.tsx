          ...
          <div className="p-6">
            ...
            <div className="terminal-text">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="bg-card/50 border-primary/20 hover:border-primary/50 transition-all duration-300 terminal-hover group">
                  <div className="p-4">
                    ...
                    <div className="text-primary/80 text-lg mb-2">[1] Drum Kit</div>
                    <div className="space-y-1 text-sm">
                      <div>├── Tech: JavaScript, HTML5, CSS3</div>
                      <div>├── Features: Interactive drum sounds, keyboard controls</div>
                ...
                <Card className="bg-card/50 border-primary/20 hover:border-primary/50 transition-all duration-300 terminal-hover group">
                  <div className="p-4">
                    ...
                    <div className="text-primary/80 text-lg mb-2">[2] Shop.co (Figma Design)</div>
                    <div className="space-y-1 text-sm">
                ...
                <Card className="bg-card/50 border-primary/20 hover:border-primary/50 transition-all duration-300 terminal-hover group">
                  <div className="p-4">
                    ...
                    <div className="text-primary/80 text-lg mb-2">[3] Workroom</div>
                    <div className="space-y-1 text-sm">
                      <div>├── Tech: React, Node.js, Express, MongoDB</div>
                      <div>├── Features: Team collaboration, project management</div>
                ...
                <Card className="bg-card/50 border-primary/20 hover:border-primary/50 transition-all duration-300 terminal-hover group">
                  <div className="p-4">
                    ...
                    <div className="text-primary/80 text-lg mb-2">[4] Rozoviy Sad (Flower Shop)</div>
                    <div className="space-y-1 text-sm">
                ...
                <Card className="bg-card/50 border-primary/20 hover:border-primary/50 transition-all duration-300 terminal-hover group">
                  <div className="p-4">
                    ...
                    <div className="text-primary/80 text-lg mb-2">[5] Dev Connect</div>
                    <div className="space-y-1 text-sm">
                ...
                <Card className="bg-card/50 border-primary/20 hover:border-primary/50 transition-all duration-300 terminal-hover group">
                  <div className="p-4">
                    ...
                    <div className="text-primary/80 text-lg mb-2">[6] YouTube Backend Clone</div>
                    <div className="space-y-1 text-sm">
              ...
              <Card className="bg-card/30 border-primary/20 mt-6">
                <div className="p-4">
                  <div className="text-primary/80 text-lg mb-3">[7] Additional Projects</div>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    <div className="space-y-2">
                      <div className="text-primary/70">Learning Center Management</div>
